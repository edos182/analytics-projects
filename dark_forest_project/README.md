...
Остальные таблицы базы данных в рамках данного исследования не использовались.
...
- Несмотря на схожую долю покупателей среди рас, наблюдаются различия в количестве покупок и объёме расходов. Рекомендуется дополнительно изучить причины этих различий.
