...
- Выявлены наиболее популярные темы и теги выступлений TED.
- Проанализирована реакция аудитории на различные выступления.
- Определены характеристики наиболее успешных спикеров.
- Исследованы показатели просмотров, аплодисментов и количества смеха аудитории.
- Разработан интерактивный дашборд для анализа конференций TED и поддержки принятия решений при организации мероприятий.
